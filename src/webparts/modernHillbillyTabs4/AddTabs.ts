...
//                             r
//                                 .addClass("addui-Tabs-content")
//                                 .each(function (d, s) {
//                                     a(s).hasClass("active") &&
//                                         (a(s).removeClass("active"), (u = d));
//                                 }),
//                             r
//                                 .removeClass("addui-Tabs-active")
//                                 .eq(u)
//                                 .addClass("addui-Tabs-active"),
//                             c
//                                 .removeClass("addui-Tabs-active")
//                                 .eq(u)
//                                 .addClass("addui-Tabs-active");
//                         var l = "click";
//                         "hover" == i.change && (l = "mouseenter"),
//                             c.on(l, function (a) {
//                                 c.each(function (d, s) {
//                                     s == a.target &&
//                                         ((u = d),
...
//                 );
//             }),
//             (a.fn.addTabs = function (a) {
//                 $add.Tabs(this, a);
//             }),
//             ($add.auto.Tabs = function () {
//                 $add.auto.disabled || a("[data-addui=tabs]").addTabs();
//             });
//     })(jQuery);
//     $(function () {
